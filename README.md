...
##https://wesscarpa.github.io/index.html#projects
...
A custom-built cinematic text crawl implemented using CSS transforms and JavaScript timing control to recreate the perspective scrolling effect.

### Interactive Simulations

Embedded browser-based simulations that demonstrate technical projects directly within the site using dynamic JavaScript logic and DOM manipulation.

### Responsive Design

Custom CSS layout built to adapt across screen sizes without external frameworks.

### Modular JavaScript Structure

Organized, reusable JavaScript components designed for scalability and maintainability.

### Performance-Focused Architecture

Minimal dependencies, lightweight structure, and optimized animation handling.
